...
public class ScoreBoardManager {
	...
	private void createOrRegenerateSidebar() {
		...
		obj.getScore(Bukkit.getOfflinePlayer(ChatColor.WHITE + formatter.format(chronometre.getHours()) + ChatColor.GRAY + ":" + ChatColor.WHITE + formatter.format(chronometre.getMinutes())
